...
@Title : main code of perform aggregate function on table
"""
...
import loggerfile
from Aggregate_Function_mysql import Aggregate_Function
...
def main():
    ...
    try:
        ...
        if(mode==0):
            print(Obj_Aggregate_Function.Count_Fuction())
        elif(mode==1):
            print(Obj_Aggregate_Function.Sum_Fuction())
        elif(mode==2):
            print(Obj_Aggregate_Function.AVG_Fuction())
        elif(mode==3):
            print(Obj_Aggregate_Function.Min_Fuction())
        elif(mode==4):
            print(Obj_Aggregate_Function.Max_Fuction())
        elif(mode==5):
